...
const Contact: React.FC = () => {
  return (
    <section id="get-in-touch" className="py-24 bg-white scroll-mt-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-pw-blue font-bold tracking-wider uppercase text-sm">Get In Touch</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-white border-2 border-slate-200 rounded-2xl p-8 md:p-12">
              <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-6">
                <Calendar className="w-6 h-6 text-pw-blue" />
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-pw-blue text-white font-bold px-8 py-4 rounded-xl hover:bg-blue-700 transition-all shadow-md hover:shadow-lg hover:-translate-y-1 group"
              >
                Book an Appointment
