    ...
    <section id="get-in-touch" className="py-16 sm:py-20 md:py-24 bg-white scroll-mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          >
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Contact Information</h3>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                    <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-pw-blue" />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-base">Email</h4>
                    <a href="mailto:contact@pwleapx.com" className="text-sm sm:text-base text-slate-600 hover:text-pw-blue transition-colors break-all">
                      contact@pwleapx.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-pw-blue" />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1 text-sm sm:text-base">Phone</h4>
                    <a href="tel:+917240981514" className="text-sm sm:text-base text-slate-600 hover:text-pw-blue transition-colors">
                      +91 72409 81514
                    </a>
            ...
            <div className="pt-6 sm:pt-8 border-t border-slate-100">
              <p className="text-xs sm:text-sm text-slate-500 mb-3 sm:mb-4">Powered by</p>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-white border-2 border-slate-200 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 lg:p-12">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-50 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6">
              ...
              <p className="text-slate-600 text-sm sm:text-base md:text-lg mb-5 sm:mb-6 md:mb-8 leading-relaxed">
